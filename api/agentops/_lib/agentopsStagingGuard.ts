/**
 * STAGING-TOOLS-1 — AgentOps staging Supabase project ref guard (server-side).
 * Blocks execution/write routes when configured Supabase is not the staging project.
 */
...
/** Evaluate staging guard without side effects. */
...
/** Returns a 403 Response when execution must be blocked; null when allowed. */
