# AgentOps Memory — AgentOps Owner QA
## Status
Static memory file.
...
## Agent Identity
* Agent ID: agentops-owner
* Display Name: AgentOps Owner QA
* Synthetic Email: qa+agentops-owner@aixia.local
* Agent Skill / Specialty: Final Council Chair and Implementation Planner
* App Role: admin
* AgentOps Owner Access: Yes
* Allowed Modules: `dashboard`, `projects`, `tasks`, `calendar`, `chat`, `finance`, `employees`, `ai-management`, `system-agent-ops`
