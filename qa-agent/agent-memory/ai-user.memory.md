...
## Agent Identity
* Agent ID: ai-user
* Display Name: AI User QA
* Synthetic Email: qa+agentops-ai-user@aixia.local
* Agent Skill / Specialty: Personal AI Productivity Agent
* App Role: employee
* AgentOps Owner Access: No
* Allowed Modules: `dashboard`, `chat`, `ai-management`
