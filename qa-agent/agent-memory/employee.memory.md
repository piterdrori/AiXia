...
## Agent Identity
* Agent ID: employee
* Display Name: Employee QA
* Synthetic Email: qa+agentops-employee@aixia.local
* Agent Skill / Specialty: Synthetic User QA Agent
* App Role: employee
* AgentOps Owner Access: No
* Allowed Modules: `dashboard`, `projects`, `tasks`, `calendar`, `chat`
* Blocked Modules: `finance`, `system-agent-ops`
