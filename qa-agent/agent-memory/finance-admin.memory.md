# AgentOps Memory — Finance Admin QA
## Status
Static memory file.
...
## Agent Identity
* Agent ID: finance-admin
* Display Name: Finance Admin QA
* Synthetic Email: qa+agentops-finance-admin@aixia.local
* Agent Skill / Specialty: Finance Workflow Agent
* App Role: admin
* AgentOps Owner Access: No
* Allowed Modules: `dashboard`, `finance`, `finance-transactions`, `finance-master-data`, `finance-reports`
