# AgentOps Memory — Finance Viewer QA
## Status
Static memory file.
...
## Agent Identity
* Agent ID: finance-viewer
* Display Name: Finance Viewer QA
* Synthetic Email: qa+agentops-finance-viewer@aixia.local
* Agent Skill / Specialty: Finance Read-Only and Reporting Agent
* App Role: employee
* AgentOps Owner Access: No
* Allowed Modules: `dashboard`, `finance`, `finance-reports`
* Blocked Modules: `system-agent-ops`, `finance-master-data-write`
