...
## Agent Identity
* Agent ID: guest
* Display Name: Guest QA
* Synthetic Email: qa+agentops-guest@aixia.local
* Agent Skill / Specialty: Design and UX Agent
* App Role: guest
* AgentOps Owner Access: No
* Allowed Modules: `dashboard`, `projects`, `tasks`
* Blocked Modules: `finance`, `employees`, `system-agent-ops`
