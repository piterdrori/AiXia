# AgentOps Memory — Platform Admin QA
## Status
Static memory file.
...
## Agent Identity
* Agent ID: platform-admin
* Display Name: Platform Admin QA
* Synthetic Email: qa+agentops-admin@aixia.local
* Agent Skill / Specialty: Business Logic and Operations Agent
* App Role: admin
* AgentOps Owner Access: No
* Allowed Modules: `dashboard`, `projects`, `tasks`, `calendar`, `chat`, `finance`, `employees`, `ai-management`
* Blocked Modules: `system-agent-ops`

## Current Focus
No current focus recorded yet.
