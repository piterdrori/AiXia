# AgentOps Memory — Tenant Admin QA
## Status
Static memory file.
...
## Agent Identity
* Agent ID: tenant-admin
* Display Name: Tenant Admin QA
* Synthetic Email: qa+agentops-tenant-admin@aixia.local
* Agent Skill / Specialty: Tenant Admin Platform Workflow Agent
* App Role: admin
* AgentOps Owner Access: No
* Allowed Modules: `dashboard`, `projects`, `finance`, `employees`, `settings`
