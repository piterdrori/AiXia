# AgentOps Memory — Vendor External QA
## Status
Static memory file.
...
## Agent Identity
* Agent ID: vendor-external
* Display Name: Vendor External QA
* Synthetic Email: qa+agentops-vendor-external@aixia.local
* Agent Skill / Specialty: Security, Permissions, and Tenant Isolation Agent
* App Role: guest
* AgentOps Owner Access: No
* Allowed Modules: `dashboard`
* Blocked Modules: `finance`, `employees`, `projects`, `system-agent-ops`
