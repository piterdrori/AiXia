...
if (!status.emailPresent || !status.passwordPresent) {
  console.warn(
    "Owner credentials not configured; smoke will report skipped. Set AGENTOPS_QA_OWNER_EMAIL and AGENTOPS_QA_OWNER_PASSWORD in the shell or gitignored .env.local / qa-agent/browser-qa/.env.owner.local.",
  );
}
