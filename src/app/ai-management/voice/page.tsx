    ...
    <AixiaPage surface="command" className="aixia-command-page aixia-ai-management-page"><AixiaHero
      ...
      <div className="aixia-command-scroll flex flex-col gap-6">
        ...
        <section className="grid gap-5">
          <div className="grid h-[980px] overflow-hidden rounded-[34px] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(6,182,212,0.20),rgba(2,6,23,0.94)_42%,rgba(2,6,23,0.99))] shadow-2xl shadow-cyan-950/20 xl:grid-cols-[380px_minmax(0,1fr)]">
            ...
            <div className="flex min-h-0 min-w-0 flex-col overflow-hidden">
              ...
              <div className="grid min-h-0 flex-1 grid-rows-[minmax(0,1fr)_190px] gap-0 overflow-hidden">
                <div className="flex min-h-0 flex-col overflow-hidden">
                  <div
                    ref={chatScrollRef}
                    className="h-full min-h-[520px] space-y-4 overflow-y-auto px-5 py-5"
                  >
                  ...
                  <div className="shrink-0 border-t border-white/10 p-4">
                    <div className="rounded-[26px] border border-white/10 bg-black/25 p-3">
                      <textarea
                        ...
                        className="h-[64px] w-full resize-none rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 text-sm leading-6 text-white outline-none transition placeholder:text-slate-600 focus:border-cyan-400/40"
                      />
