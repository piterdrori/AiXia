...
type FinanceBankAccountRow = {
  ...
  finance_chart_of_accounts: LedgerAccountRelation;
};
...
function normalizeLedgerRelation(
  relation: LedgerAccountRelation
): FinanceBankAccount["finance_chart_of_accounts"] {
  if (!relation) {
    return null;
  }
...
export default function FinanceBankAccountsPage() {
  ...
  async function loadAccounts() {
    try {
      ...
      const normalized = ((data || []) as FinanceBankAccountRow[]).map((row) => ({
        ...row,
        finance_chart_of_accounts: normalizeLedgerRelation(
          row.finance_chart_of_accounts
        ),
      }));
            ...
            <div className="border border-border rounded-2xl bg-background/40 overflow-hidden">
              <div className="border-b border-border px-5 py-4">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Modern operational bank setup with ledger connection and
                  finance controls.
                </p>
              </div>
            ...
            <div className="border-b border-border px-5 py-4 flex items-center justify-between gap-3">
              <div>
                ...
                <div className="text-sm text-muted-foreground mt-1">
                  Operational accounts with payment, default, and ledger linkage
                  visibility.
                </div>
              </div>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <div className="text-xs text-muted-foreground mt-1">
                            {acc.institution_name || "No bank name"} •{" "}
                            {acc.account_type}
                          </div>
                        </div>
