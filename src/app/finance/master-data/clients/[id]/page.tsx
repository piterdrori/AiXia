    ...
    <>
          ...
          <section className="relative z-10 flex-shrink-0 overflow-hidden rounded-[30px] border border-white/10 bg-[linear-gradient(135deg,rgba(34,211,238,0.08),rgba(139,92,246,0.08),rgba(255,255,255,0.03))] backdrop-blur-xl">
            ...
            <div className="relative flex items-center justify-between gap-4 px-5 py-5 sm:px-6 xl:px-7">
              <div className="min-w-0">
                ...
                <div className="mt-2 text-sm text-white/50">
                  Client record with structured section editing.
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
              ...
              >
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  ...
                  <DisplayRow label="Contact Person" value={client.contact_person || "—"} />
                  <DisplayRow label="Email" value={client.company_email || "—"} />
                  <DisplayRow label="Phone" value={client.company_phone || "—"} />
                  <DisplayRow label="Status" value={client.status || "—"} />
                </div>
              </SectionCard>

              <SectionCard title="System Fields" description="Read-only audit fields.">
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
              ...
              <SectionCard
                ...
                description="Related people for this client."
                    ...
                    personnel.map((row, index) => (
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                          ...
                          <DisplayRow label="Position" value={row.position || "—"} />
      ...
      {editingSection === "basic" && (
        ...
        >
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="md:col-span-2">
              ...
              <InputField
                ...
                onChange={(e) =>
                  setBasicForm((prev) => ({ ...prev, legal_name: e.target.value }))
                }
              />
            </div>
          ...
          {modalError && <div className="mt-4 text-sm text-rose-300">{modalError}</div>}
        </ModalShell>
      )}
      ...
      {editingSection === "personnel" && (
        <ModalShell
          ...
          description="Manage related people for this client."
          onClose={() => setEditingSection(null)}
        ...
        >
          <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  <div>
                    ...
                    <InputField
                      value={row.full_name}
                      onChange={(e) =>
                        updatePersonnelFormRow(row.id, "full_name", e.target.value)
                      }
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <InputField
                      value={row.position}
                      onChange={(e) =>
                        updatePersonnelFormRow(row.id, "position", e.target.value)
                      }
                    />
                  </div>
            ...
            {modalError && <div className="text-sm text-rose-300">{modalError}</div>}
          </div>
        </ModalShell>
      )}
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <InputField
                      value={row.postal_code}
                      onChange={(e) =>
                        updateAddressFormRow(row.id, "postal_code", e.target.value)
                      }
                    />
                  </div>
                    ...
                    <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                      <div>
                        ...
                        <InputField
                          value={row.country}
                          onChange={(e) =>
                            updateShippingFormRow(row.id, "country", e.target.value)
                          }
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <InputField
                          value={row.city}
                          onChange={(e) =>
                            updateShippingFormRow(row.id, "city", e.target.value)
                          }
                        />
                      </div>
