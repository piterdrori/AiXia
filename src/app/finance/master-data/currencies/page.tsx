...
const CURRENCY_PRESETS: CurrencyPreset[] = [
  {
    ...
    symbol: "$",
    decimal_places: "2",
    aliases: ["usd", "us dollar", "dollar", "american dollar"],
  },
  {
    code: "EUR",
    name: "Euro",
  ...
  },
  {
    ...
    symbol: "¥",
    decimal_places: "2",
    aliases: ["cny", "chinese yuan", "yuan", "renminbi", "rmb"],
  },
  {
    code: "GBP",
    name: "British Pound",
    symbol: "£",
    decimal_places: "2",
    aliases: ["gbp", "british pound", "pound sterling", "sterling"],
  },
  {
    code: "JPY",
    name: "Japanese Yen",
  ...
  },
  {
    ...
    symbol: "₪",
    decimal_places: "2",
    aliases: ["ils", "israeli new shekel", "shekel", "nis"],
  },
  {
    code: "SGD",
...
function deriveCodeFromName(name: string) {
  ...
  return normalizedTokens.join("").slice(0, 3).toUpperCase();
}

function applyCurrencyNameAutomation(
  current: CurrencyFormState,
  nextName: string,
): CurrencyFormState {
  const normalized = nextName.trim().toLowerCase();
  const preset = CURRENCY_PRESETS.find((item) =>
...
export default function FinanceMasterDataCurrenciesPage() {
  ...
  const loadPage = useCallback(async () => {
    ...
    try {
      ...
      if (baseRow?.currency_code) {
        setConvertFrom(baseRow.currency_code);
      }

      if (secondRow?.currency_code) {
          ...
          {canView || loading ? (
            <>
              ...
              <section className="grid grid-cols-1 gap-6">
                <Card className="flex h-[520px] min-h-0 flex-col overflow-hidden rounded-[30px] border border-white/10 bg-white/[0.045] backdrop-blur-xl">
                  ...
                  <CardContent className="min-h-0 flex-1 p-0">
                    <div className="h-full overflow-auto">
                      <table className="w-full min-w-[1080px]">
                        <thead className="sticky top-0 z-[1] bg-[#0f1726]/95 backdrop-blur-xl">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  readOnly
                  placeholder="Automatic from currency name"
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setCurrencyForm((prev) =>
                      applyCurrencyNameAutomation(prev, e.target.value),
                    )
                  }
