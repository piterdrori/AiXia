  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const created = await createVendorBankAccount({
        ...
        account_identifier_type: form.account_identifier_type.trim() || null,
          ...
          <div className="relative flex items-center justify-between gap-4 px-5 py-5 sm:px-6 xl:px-7">
            <div className="min-w-0">
              ...
              <div className="mt-2 text-sm text-white/50">
                Vendor selection, bank details, identifier, currency, control,
                and notes.
              </div>
            </div>
            ...
            <div className="flex shrink-0 items-center gap-3">
              ...
              <Button
                type="submit"
                form="vendor-bank-account-create-form"
                variant="outline"
                disabled={isSaving}
                className="h-11 rounded-2xl border-white/10 bg-white/5 px-4 text-white hover:bg-white/10"
              >
                <Save className="mr-2 h-4 w-4" />
                {isSaving ? "Saving..." : "Create Vendor Bank Account"}
              </Button>
            </div>
          </div>
        </section>
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <InputField
                      ...
                      placeholder="Auto from vendor, can edit"
                    />
                  </div>

                  <div>
                    <FieldLabel label="Vendor Currency" />
                    <div className="flex h-11 items-center rounded-2xl border border-white/10 bg-white/5 px-4 text-sm text-white/70">
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <InputField
                      ...
                      onChange={(e) =>
                        updateForm("currency_code", e.target.value.toUpperCase())
                      }
