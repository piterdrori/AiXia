  ...
  if (isLoading) {
    return (
      <AixiaLoadingState
        ...
        description="Proof-ready and verified expenses, funding pools, employee identities, currency master data, and existing allocation lifecycle records are being loaded."
      />
    );
  }
  ...
  return (
    <AixiaPage>
      <AixiaHero
        ...
        title=""
        subtitle="Distribute reserved funding pool money across proof-ready or verified expenses"
        description="Use a confirmed Funding Pool to distribute reserved company money across eligible operating expenses. Currency conversion uses the selected payment date and allocation lifecycle data is loaded from the backend."
        statusCards={[
          {
        ...
        main={
          <>
              ...
              <AixiaFormGrid columns="two">
                <AixiaFormField>
                  ...
                  <AixiaValueBlock
                    ...
                    detail="This page only distributes funding pool money to proof-ready or verified operating expenses."
                  />
                </AixiaFormField>
            ...
            <AixiaChildAllocationRegistry
              ...
              description="Select eligible expenses, enter payment-currency amounts, and review payment-date conversion before creating backend allocation records."
              icon={Receipt}
              search={
                <AixiaSearchField
                  width="wide"
            ...
            >
              {sortedFilteredExpenses.length === 0 ? (
                <AixiaEmptyState
                  icon={Search}
                  title="No payable eligible expenses found"
                  description="Expenses must be proof-ready or verified and still have a remaining balance."
                />
              ) : (
