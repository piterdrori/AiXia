...
export default function InvoicePrintDocument({
  ...
  // Parse bank details if they're in the snapshot format "Beneficiary | Bank | IBAN | SWIFT"
                      ...
                      >
                        <div style={{ display: "grid", gap: "2.5mm" }}>
                          ...
                          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3mm" }}>
                            {bankInfo.bank && (
                              <div style={{ display: "flex", flexDirection: "column", gap: "0.5mm" }}>
                                <span style={{ fontSize: "7pt", color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em" }}>Bank</span>
                                <span style={{ fontWeight: 500, color: "#374151" }}>{bankInfo.bank}</span>
                              </div>
                            )}
                          </div>

                          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3mm", marginTop: "1mm" }}>
                            {bankInfo.iban && (
                              <div style={{ display: "flex", flexDirection: "column", gap: "0.5mm" }}>
                                <span style={{ fontSize: "7pt", color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em" }}>IBAN</span>
                                <span style={{ 
                                  fontFamily: "monospace", 
                                  fontWeight: 600, 
                                  fontSize: "8pt", 
                            ...
                            {bankInfo.swift && (
                              <div style={{ display: "flex", flexDirection: "column", gap: "0.5mm" }}>
                                <span style={{ fontSize: "7pt", color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em" }}>SWIFT/BIC</span>
                                <span style={{ 
                                  fontFamily: "monospace", 
                                  fontWeight: 600, 
                                  fontSize: "8pt", 
