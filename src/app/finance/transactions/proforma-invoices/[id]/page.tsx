          ...
          <div className="relative flex flex-col gap-6">
            <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
              <div className="max-w-4xl space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-sm text-white/50">
                    ...
                    issuance. Drafts are editable. Accepted proformas can be
              ...
              <div className="flex flex-wrap gap-3 xl:justify-end">
                ...
                <Button
                  variant="outline"
                  onClick={() => void loadProforma(true)}
              ...
              <CardHeader className="border-b border-white/8 pb-4">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <CardDescription className="text-white/45">
                      Draft proforma invoices can be edited here. Sent, accepted,
                      and converted records are read-only.
                    </CardDescription>
                  </div>
            ...
            <Card className="overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.045] backdrop-blur-xl">
              ...
              <CardContent className="space-y-3 p-5">
                <div className="rounded-[18px] border border-white/8 bg-black/15 px-4 py-4 text-sm text-white/55">
                  Delete logic is soft-first. Archive moves the proforma invoice to
