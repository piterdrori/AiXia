...
const features = [
  {
    ...
    description:
      "Organize projects with intuitive boards, lists, and timelines. Track progress effortlessly.",
  },
  {
    icon: CheckSquare,
    title: "Task Tracking",
  ...
  },
  {
    ...
    title: "Built-in Chat",
    description:
      "Communicate with your team without leaving the platform.",
  },
  {
    icon: Calendar,
    title: "Calendar View",
    description:
      "Visualize deadlines and milestones with integrated calendar views.",
  },
  {
    icon: Shield,
    title: "Role-based Access",
    description:
      "Control permissions with granular access levels for different team members.",
  },
];
...
const steps = [
  {
    ...
    description:
      "Set up your organization and invite team members in minutes.",
  },
  {
    number: "02",
    title: "Plan Your Projects",
    description:
      "Create projects, set milestones, and assign tasks to your team.",
  },
  {
    number: "03",
    title: "Track & Collaborate",
    description:
      "Monitor progress, communicate in real-time, and deliver on time.",
  },
];
...
const testimonials = [
  {
    ...
    company: "TechCorp",
    content:
      "TaskFlow transformed how our team works. The real-time collaboration features are incredible.",
    avatar: "SJ",
  },
  {
    name: "Michael Chen",
    ...
    company: "StartupX",
    content:
      "Finally a project management tool that developers actually enjoy using. Clean, fast, and intuitive.",
    avatar: "MC",
  },
  {
    name: "Emily Davis",
    ...
    content:
      "The visual workflow and task boards make it easy to keep track of all our design projects.",
    avatar: "ED",
  },
];
...
async function getLandingAccessState(): Promise<LandingAccessState> {
  try {
    const {
      data: { session },
      error: sessionError,
    ...
    console.error("Landing access state error:", error);
    return "unauthenticated";
  }
}
...
export default function LandingPage() {
  ...
  const [accessState, setAccessState] =
    useState<LandingAccessState>("unauthenticated");

  const refreshAccessState = useCallback(async () => {
    const nextState = await getLandingAccessState();
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-slate-400 mb-8 max-w-2xl mx-auto">
              TaskFlow helps teams organize work, collaborate in real-time, and
              deliver projects on time. The modern project management platform
              built for speed.
            </p>
      ...
      <section className="py-20 border-t border-slate-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-400 mb-8 max-w-xl mx-auto">
            Join thousands of teams already using TaskFlow to deliver projects
            faster.
          </p>
